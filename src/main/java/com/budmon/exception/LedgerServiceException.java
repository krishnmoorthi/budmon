...
public class LedgerServiceException extends Exception {
	 ...
	 * @param cause
	 */
	public LedgerServiceException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 */
	public LedgerServiceException(String message, Throwable cause, boolean enableSuppression,
